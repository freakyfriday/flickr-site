...
module.exports = "<!--The content below is only a placeholder and can be replaced.-->\n<div ngClass=\"container centered\">\n    <div style=\"min-height:100px;\">\n      <h1 ngClass=\"animated slideInDown\" style=\"line-height:100px;\">\n        Welcome to {{ title }}!\n      </h1>\n    </div>\n    \n    <div ngClass=\"animated fadeIn\">\n      <app-photos></app-photos>\n    </div>\n\n  <router-outlet></router-outlet>\n</div>\n"
...
var PhotoService = /** @class */ (function () {
    ...
    PhotoService.prototype.getPublicPhotos = function () {
        return this.http.get('https://flickr-api.azurewebsites.net/photos/public');
    };
    PhotoService.prototype.searchPublicPhotos = function (searchString) {
        return this.http.post('https://flickr-api.azurewebsites.net/photos/search', { searchString: searchString });
    };
...
module.exports = "<p>\n  <img ngClass=\"img-fluid animated fadeIn photo\" src=\"{{photo.media.m}}\">\n</p>\n"
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3Bob3RvL3Bob3RvLmNvbXBvbmVudC5zY3NzIn0= */"
...
module.exports = "<div>\n    <div class=\"input-group mb-3\">\n      <input type=\"text\" class=\"form-control\" [(ngModel)]=\"searchString$\" (keydown.enter)=\"searchPublicPhotos()\" placeholder=\"Search photos by keyword\" aria-label=\"Search photos by keyword\" aria-describedby=\"basic-addon2\">\n      <div class=\"input-group-append\">\n        <button class=\"btn btn-outline-secondary\" type=\"button\" (click)=\"searchPublicPhotos()\">Search</button>\n      </div>\n    </div>\n</div>\n\n<ul ngClass=\"list-group\">\n  <li ngClass=\"list-group-item\" *ngFor=\"let photo of photos$\"> \n    <app-photo [photo]=photo></app-photo>\n  </li>\n</ul>"
...
var PhotosComponent = /** @class */ (function () {
    ...
    PhotosComponent.prototype.getPublicPhotos = function () {
        var _this = this;
        //subscribe to public photos results
        this.data.getPublicPhotos().subscribe(function (data) {
            _this.photos$ = (data && data.items) ? data.items : [];
        });
    };
    PhotosComponent.prototype.searchPublicPhotos = function () {
        var _this = this;
        //subscribe to photo search results
        if (!lodash__WEBPACK_IMPORTED_MODULE_3___default.a.isEmpty(this.searchString$)) {
            this.data.searchPublicPhotos(this.searchString$).subscribe(function (data) {
                _this.photos$ = (data && data.items) ? data.items : [];
            });
        }
        else {
    ...
    PhotosComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_photo_service__WEBPACK_IMPORTED_MODULE_2__["PhotoService"]])
    ], PhotosComponent);
...
module.exports = __webpack_require__(/*! /Users/francesco/Dropbox/JobTests/flickr-site/src/main.ts */"./src/main.ts");
